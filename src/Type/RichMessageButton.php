 ...
 */
final readonly class RichMessageButton extends Type
{
    public function __construct(
         ...
         * (the button is shown as a regular link without borders). Apps may use theme-specific colors for the button background
         * and text based on the style. The style "link" is allowed only for callback buttons.
         */
        public string|null $style = null,

        /**
         * Optional. HTTP or tg:// URL to be opened when the button is pressed. Links tg://user?id=<user_id> can be used to mention
        ...
        /**
         * Optional. Description of the Web App that will be launched when the user presses the button. The Web App will be able
         * to send an arbitrary message on behalf of the user using the method answerWebAppQuery. Available only in private chats
         ...
         * the bot's username and the specified inline query in the input field. May be empty, in which case just the bot's username
         * will be inserted. Not supported for messages sent in channel direct messages chats and on behalf of a business account.
         */
        public string|null $switchInlineQuery = null,

        /**
         * Optional. If set, pressing the button will insert the bot's username and the specified inline query in the current chat's
         * input field. May be empty, in which case only the bot's username will be inserted. Not supported in channels and for messages
         ...
         * and insert the bot's username and the specified inline query in the input field. Not supported for messages sent in channel
