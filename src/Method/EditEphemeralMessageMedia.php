...
/**
 * Use this method to edit the media of an ephemeral message. Note that it is not guaranteed that the user will receive
 * the message edit event, especially if they are offline. On success, True is returned.
 *
 * @extends Method<true>
 */
final class EditEphemeralMessageMedia extends Method
{
    protected static string $methodName = 'editEphemeralMessageMedia';
